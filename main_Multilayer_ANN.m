...
% net_x = Multilayer_ANN(10,0.75,10.0,0.01);
% net_y = Multilayer_ANN(10,0.75,10.0,0.01);
% net_z = Multilayer_ANN(10,0.75,10.0,0.01);

net_x = Multilayer_ANN(10,0.05,0.1,0.001);
net_y = Multilayer_ANN(10,0.05,0.1,0.001);
net_z = Multilayer_ANN(10,0.05,0.1,0.001);
...
for i=1:N
    ...
    u_x = net_x.Control(e(1));
    u_y = net_y.Control(e(2));
    u_z = net_z.Control(e(3));
    u = [u_x u_y u_z]';
...
save(['_multilayer_ANN_' num2str(trac)],'x_plot','xd_plot','q_plot','qp_plot','e_plot','t_plot')
