...
net_x = Single_ANN(0.2,0.1,0.001);
net_y = Single_ANN(0.2,0.1,0.001);
net_z = Single_ANN(0.2,0.1,0.001);
...
save(['_single_ANN_' num2str(trac)],'x_plot','xd_plot','q_plot','qp_plot','e_plot','t_plot')
